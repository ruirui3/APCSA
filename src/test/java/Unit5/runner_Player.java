    ...
    public static void main(String[] args) {
        ...
        while (!instruction.equals("q")) {
            ...
            if (instruction.equals("getNumPlayers")) {
                ...
                System.out.println(
                        p1.getName() + " is now at coordinates X " + p1.getX() + " Y " + p1.getY() + " Z " + p1.getZ());
                ...
                if (choice == 1) {
                    ...
                    p1.teleport(x, y, z);
                    System.out.println(
                            p1.getName() + " teleported to X " + p1.getX() + " Y " + p1.getY() + " Z " + p1.getZ());
                ...
                if (choice == 1) {
                    ...
                    scan.nextLine();
                    System.out.printf("%s is %f units from X %d Y %d Z %d", p1.getName(), p1.getDistance(x, y, z), x, y,
                            z);
                } else if (choice == 2) {
                    Player p2 = new Player("P" + (Player.getNumPlayers() + 1), 10, -5, 87);

                    System.out.printf("The distance between %s and %s is %f", p1.getName(), p2.getName(),
                            p1.getDistance(p2));
                } else {
                    System.out.println("Invalid choice");
                }
