...
public class runner_Oven {
  ...
  public static void main(String[] args) {
    ...
    while (!instruction.equals("q")) {
      System.out.println("New oven with a maximum temperature of " + oven.getMaxTemp()
          + " and a starting temperature of " + oven.getCurrentTemp() + " degrees.");

      System.out.println("To preheat the oven enter \"p\", to turn the oven off enter"
